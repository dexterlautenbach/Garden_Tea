...
add_action('admin_menu', 'The_Wheel_Menu',99);
function The_Wheel_Menu(){
    add_submenu_page(
        'garden_tea',
        'The Wheel',
        'The Wheel List',
...
function the_wheel_func(){
    ...
    <table id="garden_tea" name="garden_tea" class="garden_tea_table">
        ...
        <?php
        $orders = get_orders_ids_by_product_id(45897);
        ...
        foreach ($orders as $order_id){
            ...
            if ($order->get_status()<>"failed"){
                ...
                foreach ($items as $item) {
                    if (strpos($item, 'The Wheel') !== false) {
